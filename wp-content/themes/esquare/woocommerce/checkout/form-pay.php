...
<form id="order_review" method="post">
	...
	<table class="shop_table">
		<thead>
			<tr>
				<th class="product-name"><?php esc_html_e( 'Product', 'esquare' ); ?></th>
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'esquare' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'esquare' ); ?></th>
			</tr>
		</thead>
		<tbody>
