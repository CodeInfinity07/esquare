...
class Iconic_WooThumbs_Core_Settings {
		...
		if ( current_user_can( 'manage_options' ) && ! defined( 'ICONIC_DISABLE_DASH' ) && ! defined( 'ICONIC_WOOTHUMBS_DISABLE_DASH' ) ) {
			$settings['sections']['licence'] = array(
				...
				'fields'              => array(
					array(
						'id'       => 'licence',
						'title'    => esc_html__( 'License &amp; Billing', 'iconic-woothumbs' ),
						'subtitle' => esc_html__( 'Activate or sync your license, cancel your subscription, print invoices, and manage your account information.', 'iconic-woothumbs' ),
						'type'     => 'custom',
						'output'   => Iconic_WooThumbs_Core_Licence::admin_account_link(),
					),
					array(
						'id'       => 'account',
						'title'    => esc_html__( 'Your Account', 'iconic-woothumbs' ),
						'subtitle' => esc_html__( 'Manage all of your Iconic plugins, supscriptions, renewals, and more.', 'iconic-woothumbs' ),
						'type'     => 'custom',
	...
	public static function support_link() {
		return sprintf( '<a href="%s" class="button button-secondary" target="_blank">%s</a>', 'https://iconicwp.com/support/?utm_source=Iconic&utm_medium=Plugin&utm_campaign=iconic-woothumbs&utm_content=support-link', esc_html__( 'Submit Ticket', 'iconic-woothumbs' ) );
	}
	...
	public static function documentation_link() {
		return sprintf( '<a href="%s?utm_source=Iconic&utm_medium=Plugin&utm_campaign=iconic-woothumbs&utm_content=documentation-link" class="button button-secondary" target="_blank">%s</a>', self::get_docs_url( 'collection' ), esc_html__( 'Read Documentation', 'iconic-woothumbs' ) );
	}
	...
	public static function account_link() {
		return sprintf( '<a href="%s" class="button button-secondary" target="_blank">%s</a>', 'https://iconicwp.com/account/?utm_source=Iconic&utm_medium=Plugin&utm_campaign=iconic-woothumbs&utm_content=account-link', esc_html__( 'Manage Your Account', 'iconic-woothumbs' ) );
	}
