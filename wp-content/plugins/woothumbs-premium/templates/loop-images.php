...
<?php if ( ! empty( $images ) ) { ?>
	...
	<div class="iconic-woothumbs-images-wrap">
		...
		<?php if ( $this->settings['fullscreen_general_enable'] ) { ?>
			<a href="javascript: void(0);" style="display: none;" class="iconic-woothumbs-fullscreen" data-iconic-woothumbs-tooltip="<?php _e( 'Fullscreen', 'iconic-woothumbs' ); ?>"><i class="iconic-woothumbs-icon icon-e-11"></i></a>
		<?php } ?>

		<?php if ( $video_url ) { ?>
			<a href="javascript: void(0);" class="iconic-woothumbs-play" data-iconic-woothumbs-tooltip="<?php _e( 'Play Video', 'iconic-woothumbs' ); ?>"><i class="iconic-woothumbs-icon icon-f-29"></i></a>
		<?php } ?>
