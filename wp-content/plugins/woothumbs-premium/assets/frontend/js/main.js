(function ($, document) {
	...
	var iconic_woothumbs = {
		...
		cache: function () {
			...
			// common templates
			iconic_woothumbs.tpl.prev_arrow = '<a href="javascript: void(0);" class="iconic-woothumbs-images__arrow iconic-woothumbs-images__arrow--prev"><i class="iconic-woothumbs-icon icon-e-14"></i></a>';
			iconic_woothumbs.tpl.next_arrow = '<a href="javascript: void(0);" class="iconic-woothumbs-images__arrow iconic-woothumbs-images__arrow--next"><i class="iconic-woothumbs-icon icon-e-15"></i></a>';
			...
			iconic_woothumbs.tpl.fullscreen_button = '<a href="javascript: void(0);" class="iconic-woothumbs-fullscreen" data-iconic-woothumbs-tooltip="' + iconic_woothumbs_vars.text.fullscreen + '"><i class="iconic-woothumbs-icon icon-e-11"></i></a>';
			iconic_woothumbs.tpl.play_button = '<a href="javascript: void(0);" class="iconic-woothumbs-play" data-iconic-woothumbs-tooltip="' + iconic_woothumbs_vars.text.video + '"><i class="iconic-woothumbs-icon icon-f-29"></i></a>';
			...
			iconic_woothumbs.tpl.thumbnail_play_icon = '<div class="iconic-woothumbs-thumbnails__play-overlay"><i class="iconic-woothumbs-icon icon-f-29"></i></div>';
		...
		create_temporary_images: function (images, product_object) {
			...
			$('body').append($(iconic_woothumbs.tpl.temp_images_container).css({
				width: product_object.images.outerWidth()
			}));
			...
			if ($viewer.find('.iconic-woothumbs-zoom-controls').length <= 0 && iconic_woothumbs_vars.settings.zoom_general_zoom_type === "inner") {
				...
				if (iconic_woothumbs.is_true(iconic_woothumbs_vars.settings.navigation_general_controls) && iconic_woothumbs.get_thumbnail_count(product_object) > 1) {
					...
					if (!product_object.images_wrap.find('.iconic-woothumbs-images__arrow--prev').hasClass('slick-disabled')) {
						$zoom_controls.append('<a class="iconic-woothumbs-zoom-prev" href="javascript: void(0);"><i class="iconic-woothumbs-icon icon-e-14"></i></a>');
					}

					if (!product_object.images_wrap.find('.iconic-woothumbs-images__arrow--next').hasClass('slick-disabled')) {
						$zoom_controls.append('<a class="iconic-woothumbs-zoom-next" href="javascript: void(0);"><i class="iconic-woothumbs-icon icon-e-15"></i></a>');
					}
				...
				if (x >= offset.left && x <= offset.left + width && y >= offset.top && y <= offset.top + height) {
					...
					if (base.isBigImageReady == 1) {
						...
						if (base.options.type == 'inner') {
							...
							var hdLeft = innerLeft - base.$handlerArea.width() / 2,
